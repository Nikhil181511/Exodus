...
class _FishPageState extends State<FishPage> {
  ...
  Future<void> _launchURL() async {
    const url = 'https://www.thefishermanswharf.in/';
          ...
          children: [
            SizedBox(
              ...
              child: PageView(
                ...
                children: [
                  Image.asset('Images/fish11.jpg', fit: BoxFit.cover),
                  Image.asset('Images/fish22.jpg', fit: BoxFit.cover),
                  Image.asset('Images/fish33.jpg', fit: BoxFit.cover),
                ],
              ),
            ),
            Padding(
