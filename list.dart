              ...
              children: [
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.symmetric(horizontal: 20, vertical: 12), backgroundColor: Colors.blue,
                    textStyle: TextStyle(fontSize: 16),
                  ),
                  child: Text('Churches in Goa'),
                ),
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
