...
class _PaloPageState extends State<PaloPage> {
  ...
  Future<void> _launchURL() async {
    const url = 'https://en.wikipedia.org/wiki/Palolem_Beach';
          ...
          children: [
            SizedBox(
              ...
              child: PageView(
                ...
                children: [
                  Image.asset('Images/pal.jpg', fit: BoxFit.cover),
                  Image.asset('Images/palo.jpg', fit: BoxFit.cover),
                  Image.asset('Images/palolo.jpg', fit: BoxFit.cover),
                ],
              ),
            ),
            Padding(
